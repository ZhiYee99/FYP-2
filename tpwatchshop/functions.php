...
function database() {
    try {
        return new PDO('mysql:host=' . hn . ';dbname=' . db . ';charset=utf8', un, pw);
...
function header_template($title, $head = '') {
...
function adminHeader_template($title, $selected = 'orders') {
    $admin_links = '
