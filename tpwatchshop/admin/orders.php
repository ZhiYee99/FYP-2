...
$statement1 = $pdo->prepare('SELECT * FROM accounts WHERE id = ?');
$statement1->execute([ $_GET['id'] ]);
$accounts = $statement1->fetch(PDO::FETCH_ASSOC);
?>
<?=adminHeader_template('Orders', 'orders')?>
